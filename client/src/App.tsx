...
function Router() {
  return <Switch><Route path="/" component={Home} /><Route path="/admin/comparables" component={AdminComparables} /><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch>;
}
